...
desplot(data = dat,
        ...
        main = "Field layout", xlab = "", ylab = "", show.key = F) # formatting
```
...
As a result, we find that the model with random block effects has the smaller s.e.d. and is therefore more accurate in terms of comparing genotypes.
