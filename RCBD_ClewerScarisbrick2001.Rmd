...
# data (import via URL)
dat <- read_csv("https://raw.githubusercontent.com/SchmidtPaul/DSFAIR/master/data/Clewer%26Scarisbrick2001.csv")
```
...
## Formatting
Before anything, the columns `block` and `cultivar` should be encoded as factors, since R by default encoded them as numeric.
...
Finally, we can plot the raw data
...
ggplot() +
  ...
  ylim(0, NA) + # forces y-axis to start at 0
