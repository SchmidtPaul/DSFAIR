...
As a result, we find that the model with fixed block effects has the slightly smaller s.e.d. and is therefore more accurate in terms of comparing genotypes.
